...
class Post extends CActiveRecord
{
    ...
    {
        return Yii::app()->createUrl('site/detail', array(
            'id'=>$this->id,
            'title'=>$this->title,
        ));
    }
...
//    {
//        return Yii::app()->createUrl('E:/data/'.$this->filename);
//    }
    /**
    ...
    public function getTagLinksHome()
    {
        $links=array();
        foreach(Tag::string2array($this->tags) as $tag)
            $links[]=CHtml::link(CHtml::encode($tag), array('site/index', 'tag'=>$tag));
        return $links;
    }
    /**
