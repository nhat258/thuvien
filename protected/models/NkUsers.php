...
/**
 * This is the model class for table "nk_users".
 *
 * The followings are the available columns in table 'nk_users':
 * @property string $ID
 ...
 */
class NkUsers extends CActiveRecord
{
	/**
	 ...
	 * @return NkUsers the static model class
	 */
