...
<!--    <a href="--><?php //echo 'E:/download/viewPdf/'.$data->filename ?><!--"-->
<!--       onclick="window.open('file:///E:/download/viewPdf/2664.pdf');">-->
<!--        --><?php //echo 'Download'?><!--</a>-->
<!---->
<!--    --><?php //echo CHtml::link("Download",'data/'.$data->filename,array('class'=>'donwload_link')); ?>
    <br/>
    <div class="nav">
        <b>Tags:</b>
