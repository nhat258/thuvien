	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Thể loại', 'url'=>array('/category/admin')),
                array('label'=>'Tài liệu', 'url'=>array('/post/admin')),
//				array('label'=>'Quản lý đĩa', 'url'=>array('/volume/admin')),

				array('label'=>'Quản lý trang', 'url'=>array('/page/index')),
