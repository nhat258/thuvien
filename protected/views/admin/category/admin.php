...
//        'id',
        array(
            ...
            'filter' => CHtml::activeDropDownList($model, 'parentId', CHtml::listData(Category::model()->findAll("parentId is null"),"id", "name"), array("empty" => "Chọn thể loại")),
        ),
        'name',
        array(
            'name'        => 'rank',
...
<?php echo CHtml::ajaxSubmitButton('Xóa', array('category/ajaxUpdate', 'act' => 'doDelete'), array('success' => 'reloadGrid', 'beforeSend' => 'function(){
            return confirm("Bạn chắc chắn muốn xóa thể loại?")
        }',)); ?>
